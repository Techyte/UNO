...
namespace UNO.Server
{
    public class GameManager : MonoBehaviour
    {
        ...
        private Card Draw()
        {
            Card returnCard = new Card(deck[deck.Count - 1].colour, deck[deck.Count - 1].type,
                deck[deck.Count - 1].secondaryType);
        ...
        private void Start()
        {
            ...
            players = new UNOPlayer[_networkManager.Server.ClientCount];
